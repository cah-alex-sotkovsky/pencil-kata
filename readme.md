...
4. What if a pencil with a durability of 1 is instructed to write "Hi"? Should it skip the "H" because it lacks durability and write the "i"?
   Or should it not write the word at all?
        - Currently, the write function will skip the "H" and continue to write out the "i"

## Things I would want some guidance on from a tech lead
1. The edit function feels big (lots of nested if/else's) and has some repetitive code with the write function.
   Do you have any recommendations on how I could re-factor to encapsulate some of this functionality and make it more readable?